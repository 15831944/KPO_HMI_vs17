...
private:
  ...
  int writeDataBase(const TCMessage & msg,std::string tableName,std::string telegramName);
	long newMessageCount();
	long getMessageCountXXXXX();
  std::string oracleSequence;
  std::string oracleSequenceCol;
