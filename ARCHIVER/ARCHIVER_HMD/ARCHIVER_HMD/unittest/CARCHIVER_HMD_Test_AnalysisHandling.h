#ifndef _INC_CARCHIVER_HMD_Test_AnalysisHandling_INCLUDED
#define _INC_CARCHIVER_HMD_Test_AnalysisHandling_INCLUDED
...
class CARCHIVER_HMD_Test_AnalysisHandling : public CARCHIVER_Wrapper
{
protected:
...
public:
	...
	~CARCHIVER_HMD_Test_AnalysisHandling();

	CARCHIVER_HMD_Test_AnalysisHandling(CARCHIVER_Task *Task);

  bool handleHMDHotMetalSampleTakenRDY(CEventMessage& Event, bool Steel);
...
#endif /* _INC_CARCHIVER_HMD_Test_AnalysisHandling_INCLUDED */
