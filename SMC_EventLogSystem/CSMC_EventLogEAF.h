...
long EL_ChangeProdPracPointerPlantRestriction( const char * RestriPracPt,const char * FlagHeatRelated);

long EL_ChangeProdPracPointerPlantRestriction( sEventLogMessage &EventLogMessage, const char * RestriPracPt,const char * FlagHeatRelated);

long EL_ChangeProdPracPointerPlantRestriction( const char * ProdPracPointer);

long EL_ChangeProdPracPointerPlantRestriction( sEventLogMessage &EventLogMessage, const char * ProdPracPointer);
};
#endif
