...
#pragma once
#endif
#ifndef _INC_CHDH_ACT_EVENT_RES_INCLUDED
#define _INC_CHDH_ACT_EVENT_RES_INCLUDED

#include "CSMC_DBData.h"

class CHDH_ACT_EVENT_RES
: public CSMC_DBData
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  static const std::string MESSAGE_TEXT;
  //##DBClassCodeUtility ! DO NOT EDIT !
  static const std::string TREAT_TYPE;

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDH_ACT_EVENT_RES(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDH_ACT_EVENT_RES(cCBS_Connection* Connection);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  std::string getMESSAGE_TEXT(long Row);

  //##DBClassCodeUtility ! DO NOT EDIT !
  void setMESSAGE_TEXT(const std::string& value);
...
#endif /* _INC_CHDH_ACT_EVENT_RES_INCLUDED */
