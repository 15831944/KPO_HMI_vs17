...
#pragma once
#endif
#ifndef _INC_CGC_RECIPE_SOURCE_INCLUDED
#define _INC_CGC_RECIPE_SOURCE_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CGC_RECIPE_SOURCE(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CGC_RECIPE_SOURCE(cCBS_Connection* Connection);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& PLANT, const std::string& RECIPENAME, const std::string& SOURCE);
...
#endif /* _INC_CGC_RECIPE_SOURCE_INCLUDED */
