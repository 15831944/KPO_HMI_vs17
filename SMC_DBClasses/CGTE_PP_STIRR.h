...
#pragma once
#endif
#ifndef _INC_CGTE_PP_STIRR_INCLUDED
#define _INC_CGTE_PP_STIRR_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_STIRR(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_STIRR(cCBS_Connection* Connection);
...
#endif /* _INC_CGTE_PP_STIRR_INCLUDED */
