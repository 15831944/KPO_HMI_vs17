...
#pragma once
#endif
#ifndef _INC_CGT_MAT_FEED_INCLUDED
#define _INC_CGT_MAT_FEED_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CGT_MAT_FEED(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CGT_MAT_FEED(cCBS_Connection* Connection);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& PLANT, long PLANTNO, long PRACNO, long TREATMODENO, const std::string& PRACPHASE, long LIQ_ADD_AMOUNT, const std::string& MAT_CODE, long STEPNO);
...
#endif /* _INC_CGT_MAT_FEED_INCLUDED */
