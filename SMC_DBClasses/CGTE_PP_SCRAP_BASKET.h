...
#pragma once
#endif
#ifndef _INC_CGTE_PP_SCRAP_BASKET_INCLUDED
#define _INC_CGTE_PP_SCRAP_BASKET_INCLUDED

#include "CSMC_DBData.h"

class CGTE_PP_SCRAP_BASKET
: public CSMC_DBData
{
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_SCRAP_BASKET(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_SCRAP_BASKET(cCBS_Connection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_SCRAP_BASKET();
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& PLANT, long PLANTNO, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT, const std::string& PROCPHASE, long PROCPHASENO, long BASKET_SEQUENCE_NO, long LOADINGSEQUENCE);

  //## ----------------------------------END-GENERATED-CODE--------------------- 

  //## ----------------------------------YOUR-CODE------------------------------ 

  bool selectByNextLiqAdd(const std::string& PLANT, long PLANTNO, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT, const std::string& PROCPHASE, long PROCPHASENO, long BASKET_SEQUENCE_NO, long LOADINGSEQUENCE);

};

#endif /* _INC_CGTE_PP_SCRAP_BASKET_INCLUDED */
