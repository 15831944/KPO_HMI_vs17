...
#pragma once
#endif
#ifndef _INC_CPD_SAMPLE_REF_INCLUDED
#define _INC_CPD_SAMPLE_REF_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CPD_SAMPLE_REF(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPD_SAMPLE_REF(cCBS_Connection* Connection);
  ...
  bool copySampleRef(long fromSampleRef, long toSampleRef, bool Commit, cCBS_ODBC_DBError &Error);

  long copyToNextSAMPLE_REF(long SAMPLE_REF, bool Commit);

  virtual void doOnConstruct();

  virtual void doOnDestruct();

  long getCounterSLAG_CALC(long SAMPLE_REF);

  long getCounterSTEEL_CALC(long SAMPLE_REF);

  long getCounterTEMP_CALC(long SAMPLE_REF);

  long getNextSAMPLE_REF();

  bool getNextSAMPLE_REF(long &SAMPLE_REF, cCBS_ODBC_DBError &Error);

  long getSampleCounter(long SAMPLE_REF, long MEASUREMENT_TYPE);

  std::vector<long> getSampleCounterList(long SAMPLE_REF);

  double getSampleMeasValueCALC(long SAMPLE_REF, const std::string& MEASUREMENT_NAME);

  double getSampleMeasValueSLAG(long SAMPLE_REF, const std::string& MEASUREMENT_NAME);

  double getSampleMeasValueSTEEL(long SAMPLE_REF, const std::string& MEASUREMENT_NAME);

  double getSampleMeasValueTEMP(long SAMPLE_REF, const std::string& MEASUREMENT_NAME);

  seqSample getSampleSlag(long SAMPLE_REF);

  seqSample getSampleSTEEL(long SAMPLE_REF);

  seqSample getSampleTEMP(long SAMPLE_REF);

  CDateTime getSampleTimeSTEEL(long SAMPLE_REF);

  CDateTime getSampleTimeTEMP(long SAMPLE_REF);

  long insertNewSAMPLE_REF(bool Commit, cCBS_ODBC_DBError &Error);

  long insertNewSAMPLE_REF(bool Commit);

  long insertNewSAMPLE_REF();

  bool updateSAMPLE_REF(long SAMPLE_REF, long SAMPLE_COUNTER, long MEASUREMENT_TYPE, bool Commit, cCBS_ODBC_DBError &Error);

  bool updateSAMPLE_REF(long SAMPLE_REF, long SAMPLE_COUNTER, long MEASUREMENT_TYPE);

  bool updateSampleHeatData(long SAMPLE_REF, const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, long PLANTNO, cCBS_ODBC_DBError &Error);

  bool updateSLAG_CALC(long SAMPLE_REF, long SAMPLE_COUNTER);

  bool updateSTEEL_CALC(long SAMPLE_REF, long SAMPLE_COUNTER);

  bool updateTEMP_CALC(long SAMPLE_REF, long SAMPLE_COUNTER);

  bool writeSAMPLE_REF(long SAMPLE_REF, long SAMPLE_COUNTER, long MEASUREMENT_TYPE, bool Commit, cCBS_ODBC_DBError &Error);

  bool writeSAMPLE_REF(long SAMPLE_REF, long SAMPLE_COUNTER, long MEASUREMENT_TYPE);
...
#endif /* _INC_CPD_SAMPLE_REF_INCLUDED */
