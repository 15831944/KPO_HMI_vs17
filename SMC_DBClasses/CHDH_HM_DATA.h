...
#pragma once
#endif
#ifndef _INC_CHDH_HM_DATA_INCLUDED
#define _INC_CHDH_HM_DATA_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDH_HM_DATA(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDH_HM_DATA(cCBS_Connection* Connection);
  ...
  bool copyHDH_HM_Data(const string& pHeatId, const string& pTreatId, const string& pPlant, bool pCommit);
  bool update_HeatStart(const std::string& HM_ID, const std::string& TREATID, const std::string& PLANT, const std::string& TREATENDOPER);

  bool delete_HDH_HM_DATA(const std::string& HM_ID, const std::string& TREATID, const std::string& PLANT);

  bool update_HeatDeparture(const std::string& HM_ID, const std::string& TREATID, const std::string& PLANT, const std::string& TREATENDOPER, double HMWEIGHT, double SLAGWEIGHT,double HMTEMP);

};

#endif /* _INC_CHDH_HM_DATA_INCLUDED */
