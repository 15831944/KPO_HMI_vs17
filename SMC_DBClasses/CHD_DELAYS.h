...
#pragma once
#endif
#ifndef _INC_CHD_DELAYS_INCLUDED
#define _INC_CHD_DELAYS_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CHD_DELAYS(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHD_DELAYS(cCBS_Connection* Connection);
  ...
  bool copy(const std::string& PLANT, long PLANTNO, bool Commit, cCBS_ODBC_DBError &Error);

  bool exists(const std::string& PLANT, long PLANTNO);

  bool CHD_DELAYS::copy_HMD(const string& pPlant, long pPlantNo, bool pCommit, cCBS_ODBC_DBError &pError);

};

#endif /* _INC_CHD_DELAYS_INCLUDED */
