...
#pragma once
#endif
#ifndef _INC_CHDE_PP_PROCESS_INCLUDED
#define _INC_CHDE_PP_PROCESS_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDE_PP_PROCESS(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDE_PP_PROCESS(cCBS_Connection* Connection);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT);
...
#endif /* _INC_CHDE_PP_PROCESS_INCLUDED */
