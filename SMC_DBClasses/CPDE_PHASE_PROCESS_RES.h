...
#pragma once
#endif
#ifndef _INC_CPDE_PHASE_PROCESS_RES_INCLUDED
#define _INC_CPDE_PHASE_PROCESS_RES_INCLUDED

#include "CSMC_DBData.h"

class CPDE_PHASE_PROCESS_RES
: public CSMC_DBData
{
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_PHASE_PROCESS_RES(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_PHASE_PROCESS_RES(cCBS_Connection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_PHASE_PROCESS_RES();
  ...
  bool selectMaxValuesByGroup(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT);
  ...
  bool selectSumValuesByGroup(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT);

  bool exists(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT);

  bool writeResults(const std::string & HeatID, const std::string & TreatID, const std::string & Plant, double DurSinceHeatAnnounce, const seqEAFProcessPredRes &EAFProcessPredRes);

};

#endif /* _INC_CPDE_PHASE_PROCESS_RES_INCLUDED */
