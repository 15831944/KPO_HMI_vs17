...
#pragma once
#endif
#ifndef _INC_CGTE_PP_INJECTION_INCLUDED
#define _INC_CGTE_PP_INJECTION_INCLUDED

#include "CSMC_DBData.h"

class CGTE_PP_INJECTION
: public CSMC_DBData
{
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_INJECTION(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_INJECTION(cCBS_Connection* Connection);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& PLANT, long PLANTNO, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT, const std::string& DEVICENAME);
...
#endif /* _INC_CGTE_PP_INJECTION_INCLUDED */
