...
bool CHDL_ACTUAL_RES::copy(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, bool Commit, cCBS_ODBC_DBError &Error)
{
  ...
  CPDL_ACTUAL_RES PDL_ACTUAL_RES(m_pCBS_StdConnection);
  PDL_ACTUAL_RES.addWhereClause(CPDL_ACTUAL_RES::HEATID,HEATID);
  PDL_ACTUAL_RES.addWhereClause(CPDL_ACTUAL_RES::TREATID,TREATID);
  PDL_ACTUAL_RES.addWhereClause(CPDL_ACTUAL_RES::PLANT,PLANT);

  result = result && copyByInsert(&PDL_ACTUAL_RES);
...
bool CHDL_ACTUAL_RES::exists(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT)
{
	cleanWhereStatement();
