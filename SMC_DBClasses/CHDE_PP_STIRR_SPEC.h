...
#pragma once
#endif
#ifndef _INC_CHDE_PP_STIRR_SPEC_INCLUDED
#define _INC_CHDE_PP_STIRR_SPEC_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDE_PP_STIRR_SPEC(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDE_PP_STIRR_SPEC(cCBS_Connection* Connection);
  ...
  bool selectByOrder(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT, const std::string& PRACPHASE, long STEPNO);
...
#endif /* _INC_CHDE_PP_STIRR_SPEC_INCLUDED */
