...
#pragma once
#endif
#ifndef _INC_CPDE_PHASE_BURNER_RES_INCLUDED
#define _INC_CPDE_PHASE_BURNER_RES_INCLUDED

#include "CSMC_DBData.h"

class CGCE_BURNER;

class CPDE_PHASE_BURNER_RES
: public CSMC_DBData
{
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_PHASE_BURNER_RES(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_PHASE_BURNER_RES(cCBS_Connection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_PHASE_BURNER_RES();
  ...
  bool writeResults(const std::string & HeatID, const std::string & TreatID, const std::string& PLANT, const long PLANTNO, double DurSinceHeatAnnounce, const seqEAFBurnerPredRes &SeqEAFBurnerPredRes);

  CGCE_BURNER* m_pGCE_Burner ;
};

#endif /* _INC_CPDE_PHASE_BURNER_RES_INCLUDED */
