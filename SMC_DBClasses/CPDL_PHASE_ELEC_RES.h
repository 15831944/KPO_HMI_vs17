...
#pragma once
#endif
#ifndef _INC_CPDL_PHASE_ELEC_RES_INCLUDED
#define _INC_CPDL_PHASE_ELEC_RES_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  static const std::string PHASEDUR;
  //##DBClassCodeUtility ! DO NOT EDIT !
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDL_PHASE_ELEC_RES(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDL_PHASE_ELEC_RES(cCBS_Connection* Connection);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  double getPHASEDUR(long Row);

  //##DBClassCodeUtility ! DO NOT EDIT !
  void setPHASEDUR(double value);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, const std::string& ACTIVITYNAME, const std::string& PRACPHASE, long STEPNO);
  ...
  bool writeResults(const std::string & HeatID, const std::string &TreatID, const std::string &Plant, double DurSinceHeatAnnounce, const seqLFElecPredRes & LFElecPredRes);

};

#endif /* _INC_CPDL_PHASE_ELEC_RES_INCLUDED */
