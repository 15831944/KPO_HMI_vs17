...
#pragma once
#endif
#ifndef _INC_CHD_RESTRI_ENTRY_INCLUDED
#define _INC_CHD_RESTRI_ENTRY_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CHD_RESTRI_ENTRY(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHD_RESTRI_ENTRY(cCBS_Connection* Connection);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, const std::string& DESCR_PP, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT, long LINENO);
  ...
  bool selectBySourceAndCombiName(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, long PLANTNO, const std::string& DESCR_PP, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT, long LINENO, const std::string& SOURCE, const std::string& COMBINATION_NAME);

  bool selectRestrictions(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, long PLANTNO, const std::string& SOURCE, const std::string& DESCR_PP, const std::string& COMBINATION_NAME, long PRACNO, long LIQ_ADD_AMOUNT, long TREATMODENO);

  // function returns one pair of SOURCE and COMBINATION_NAME.
  bool selectSourceAndCombiName(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, long PLANTNO, const std::string& SOURCE, const std::string& DESCR_PP, const std::string& COMBINATION_NAME, long PRACNO, long LIQ_ADD_AMOUNT, long TREATMODENO);
...
#endif /* _INC_CHD_RESTRI_ENTRY_INCLUDED */
