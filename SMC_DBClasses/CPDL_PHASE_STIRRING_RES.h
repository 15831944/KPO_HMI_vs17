...
#pragma once
#endif
#ifndef _INC_CPDL_PHASE_STIRRING_RES_INCLUDED
#define _INC_CPDL_PHASE_STIRRING_RES_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDL_PHASE_STIRRING_RES(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDL_PHASE_STIRRING_RES(cCBS_Connection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDL_PHASE_STIRRING_RES();
  ...
  bool writeResults(const std::string &HeatID, const std::string &TreatID, const string& PLANT, CDateTime HeatAnnounceTime, const seqLFStirrPredRes & LFStirrPredRes);

};

#endif /* _INC_CPDL_PHASE_STIRRING_RES_INCLUDED */
