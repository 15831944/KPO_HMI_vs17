...
#pragma once
#endif
#ifndef _INC_CHDH_HM_RES_INCLUDED
#define _INC_CHDH_HM_RES_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDH_HM_RES(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDH_HM_RES(cCBS_Connection* Connection);
  ...
  bool writeResults(const string& HM_ID, const string& TreatID, const string& PlantID, long Treat_Type, const CDateTime& Now,double d1, double SlagAmount,double TemperatureAfter,long ComputerMode,double CODur);
...
#endif /* _INC_CHDH_HM_RES_INCLUDED */
