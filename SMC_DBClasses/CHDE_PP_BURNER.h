...
#pragma once
#endif
#ifndef _INC_CHDE_PP_BURNER_INCLUDED
#define _INC_CHDE_PP_BURNER_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDE_PP_BURNER(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDE_PP_BURNER(cCBS_Connection* Connection);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT, const std::string& BURNERNAME);
...
#endif /* _INC_CHDE_PP_BURNER_INCLUDED */
