...
#pragma once
#endif
#ifndef _INC_CPDE_CYCL_MEAS_DATA_INCLUDED
#define _INC_CPDE_CYCL_MEAS_DATA_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_CYCL_MEAS_DATA(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_CYCL_MEAS_DATA(cCBS_Connection* Connection);
  ...
  bool selectByTime(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT);

  bool selectCurrentElectricalDataByHeat(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT);

  double getCurrentElectricalDataByHeat(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT);

  bool writeData(const std::string& HeatID, const std::string& TreatID, const std::string& Plant, long ActPhaseL1,
  ...
  bool writeData(const std::string& heatID, const std::string& treatID, long ActPhaseL1, double durSinceA, double durSinceH,
...
#endif /* _INC_CPDE_CYCL_MEAS_DATA_INCLUDED */
