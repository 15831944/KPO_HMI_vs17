...
#pragma once
#endif
#ifndef _INC_CHDH_CYCL_MEAS_DATA_INCLUDED
#define _INC_CHDH_CYCL_MEAS_DATA_INCLUDED

#include "CSMC_DBData.h"

class CHDH_CYCL_MEAS_DATA
: public CSMC_DBData
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDH_CYCL_MEAS_DATA(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDH_CYCL_MEAS_DATA(cCBS_Connection* Connection);
  ...
  //## ----------------------------------YOUR-CODE------------------------------ 
  bool copy(const std::string& HM_ID, const std::string& TREATID, const std::string& PLANT, bool Commit, cCBS_ODBC_DBError &Error);

  bool exists(const std::string& HM_ID, const std::string& TREATID, const std::string& PLANT);

};

#endif /* _INC_CHDH_CYCL_MEAS_DATA_INCLUDED */
