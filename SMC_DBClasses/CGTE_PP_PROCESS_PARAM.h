...
#pragma once
#endif
#ifndef _INC_CGTE_PP_PROCESS_PARAM_INCLUDED
#define _INC_CGTE_PP_PROCESS_PARAM_INCLUDED

#include "CSMC_DBData.h"

class CGTE_PP_PROCESS_PARAM
: public CSMC_DBData
{
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_PROCESS_PARAM(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_PROCESS_PARAM(cCBS_Connection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_PROCESS_PARAM();
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  double getREMEGY(long Row);

  //##DBClassCodeUtility ! DO NOT EDIT !
  void setREMEGY(double value);

  //##DBClassCodeUtility ! DO NOT EDIT !
  double getBEGINEGYWALLTEMPCTRL(long Row);

  //##DBClassCodeUtility ! DO NOT EDIT !
  void setBEGINEGYWALLTEMPCTRL(double value);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  double getMAXEGYWITHOUTBSKDATA(long Row);

  //##DBClassCodeUtility ! DO NOT EDIT !
  void setMAXEGYWITHOUTBSKDATA(double value);

  //##DBClassCodeUtility ! DO NOT EDIT !
  double getMAXEGYWITHBSKDATA(long Row);

  //##DBClassCodeUtility ! DO NOT EDIT !
  void setMAXEGYWITHBSKDATA(double value);
  ...
  long GetMaxLiqAddAmount(const std::string& PLANT, long PLANTNO, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT);

};

#endif /* _INC_CGTE_PP_PROCESS_PARAM_INCLUDED */
