...
#pragma once
#endif
#ifndef _INC_CGTE_PP_INJECTION_STEP_ENTRY_INCLUDED
#define _INC_CGTE_PP_INJECTION_STEP_ENTRY_INCLUDED

#include "CSMC_DBData.h"

class CGTE_PP_INJECTION_STEP_ENTRY
: public CSMC_DBData
{
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_INJECTION_STEP_ENTRY(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_INJECTION_STEP_ENTRY(cCBS_Connection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CGTE_PP_INJECTION_STEP_ENTRY();
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& PLANT, long PLANTNO, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT, const std::string& PRACPHASE, const std::string& DEVICENAME, long STEPNO);

  //## ----------------------------------END-GENERATED-CODE--------------------- 

  //## ----------------------------------YOUR-CODE------------------------------ 

  bool selectInjectionEntrys(long PLANTNO, long PRACNO, long TREATMODENO, const std::string&  INJTYPE);

};

#endif /* _INC_CGTE_PP_INJECTION_STEP_ENTRY_INCLUDED */
