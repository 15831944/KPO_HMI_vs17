...
#pragma once
#endif
#ifndef _INC_CPDE_PHASE_STIRRING_RES_INCLUDED
#define _INC_CPDE_PHASE_STIRRING_RES_INCLUDED

#include "CSMC_DBData.h"

class CPDE_PHASE_STIRRING_RES
: public CSMC_DBData
{
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_PHASE_STIRRING_RES(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_PHASE_STIRRING_RES(cCBS_Connection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_PHASE_STIRRING_RES();
  ...
  bool writeResults(const std::string & HeatID, const std::string & TreatID, const std::string & Plant, double durSinceA, const seqEAFGasLancePredRes &EAFGasLancePredRes);

};

#endif /* _INC_CPDE_PHASE_STIRRING_RES_INCLUDED */
