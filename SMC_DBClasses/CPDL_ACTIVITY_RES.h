...
#pragma once
#endif
#ifndef _INC_CPDL_ACTIVITY_RES_INCLUDED
#define _INC_CPDL_ACTIVITY_RES_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDL_ACTIVITY_RES(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDL_ACTIVITY_RES(cCBS_Connection* Connection);
  ...
  bool writeResults(const std::string &HeatID, const std::string &TreatID, const std::string& PLANT, CDateTime HeatAnnounceTime, const seqLFStirrPredRes & LFStirrPredRes, const seqLFElecPredRes & LFElecPredRes, const seqPredRes & LFPredRes);

};

#endif /* _INC_CPDL_ACTIVITY_RES_INCLUDED */
