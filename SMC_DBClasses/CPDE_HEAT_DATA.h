...
#pragma once
#endif
#ifndef _INC_CPDE_HEAT_DATA_INCLUDED
#define _INC_CPDE_HEAT_DATA_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  static const std::string TAPMASS;

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_HEAT_DATA(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDE_HEAT_DATA(cCBS_Connection* Connection);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  double getTAPMASS(long Row);

  //##DBClassCodeUtility ! DO NOT EDIT !
  void setTAPMASS(double value);
  ...
  bool doAnnouncement(const std::string& HEATID,const std::string& TREATID, const std::string& PLANT, long PLANTNO, const std::string &EAF_THERMSTATID, bool Commit, cCBS_ODBC_DBError &Error);

  bool exists(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT);

  double getTotalGasCons(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT);

  double getTotalOxyCons(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT);

};

#endif /* _INC_CPDE_HEAT_DATA_INCLUDED */
