...
#pragma once
#endif
#ifndef _INC_CHDE_PP_INJECTION_STEP_ENTRY_INCLUDED
#define _INC_CHDE_PP_INJECTION_STEP_ENTRY_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  static const std::string INJFLOW;
  //##DBClassCodeUtility ! DO NOT EDIT !
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDE_PP_INJECTION_STEP_ENTRY(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDE_PP_INJECTION_STEP_ENTRY(cCBS_Connection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDE_PP_INJECTION_STEP_ENTRY();
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  double getINJFLOW(long Row);

  //##DBClassCodeUtility ! DO NOT EDIT !
  void setINJFLOW(double value);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT, const std::string& PRACPHASE, const std::string& DEVICENAME, long STEPNO);

  //## ----------------------------------END-GENERATED-CODE--------------------- 

  //## ----------------------------------YOUR-CODE------------------------------ 

  bool selectByHeatPlant(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT);

  bool selectOrdered(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT, const std::string& PRACPHASE, const std::string& DEVICENAME, long STEPNO);
...
#endif /* _INC_CHDE_PP_INJECTION_STEP_ENTRY_INCLUDED */
