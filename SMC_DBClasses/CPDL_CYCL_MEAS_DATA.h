...
#pragma once
#endif
#ifndef _INC_CPDL_CYCL_MEAS_DATA_INCLUDED
#define _INC_CPDL_CYCL_MEAS_DATA_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDL_CYCL_MEAS_DATA(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPDL_CYCL_MEAS_DATA(cCBS_Connection* Connection);
  ...
  bool selectMax(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, const std::string& NumericColumnName);
...
#endif /* _INC_CPDL_CYCL_MEAS_DATA_INCLUDED */
