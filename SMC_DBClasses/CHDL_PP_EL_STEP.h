...
#pragma once
#endif
#ifndef _INC_CHDL_PP_EL_STEP_INCLUDED
#define _INC_CHDL_PP_EL_STEP_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDL_PP_EL_STEP(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDL_PP_EL_STEP(cCBS_Connection* Connection);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, long PRACNO, const std::string& ACTIVITYNAME, const std::string& PRACPHASE, long STEPNO);
...
#endif /* _INC_CHDL_PP_EL_STEP_INCLUDED */
