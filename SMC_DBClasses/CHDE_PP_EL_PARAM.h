...
#pragma once
#endif
#ifndef _INC_CHDE_PP_EL_PARAM_INCLUDED
#define _INC_CHDE_PP_EL_PARAM_INCLUDED

#include "CSMC_DBData.h"

class CHDE_PP_EL_PARAM
: public CSMC_DBData
{
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDE_PP_EL_PARAM(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CHDE_PP_EL_PARAM(cCBS_Connection* Connection);
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  bool select(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT, long PRACNO, long TREATMODENO, long LIQ_ADD_AMOUNT, const std::string& PRACPHASE);

  //## ----------------------------------END-GENERATED-CODE--------------------- 

  //## ----------------------------------YOUR-CODE------------------------------ 

  bool copy(const std::string& HeatId, 
...
#endif /* _INC_CHDE_PP_EL_PARAM_INCLUDED */
