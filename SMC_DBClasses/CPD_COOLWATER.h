...
#pragma once
#endif
#ifndef _INC_CPD_COOLWATER_INCLUDED
#define _INC_CPD_COOLWATER_INCLUDED
...
public:
  ...
  //##DBClassCodeUtility ! DO NOT EDIT !
  CPD_COOLWATER(cCBS_StdConnection* Connection);

  //##DBClassCodeUtility ! DO NOT EDIT !
  CPD_COOLWATER(cCBS_Connection* Connection);
  ...
  bool selectSetofData(const std::string& HEATID, const std::string& TREATID, const std::string& PLANT);

  bool writeData(const std::string& HeatID, const std::string& TreatID, const std::string& Plant,
...
#endif /* _INC_CPD_COOLWATER_INCLUDED */
