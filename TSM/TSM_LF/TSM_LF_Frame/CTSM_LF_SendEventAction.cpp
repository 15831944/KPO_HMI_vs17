...
void CTSM_LF_SendEventAction::execute(CTrackingObject* pObjectForAction)
{
...
CTSM_LF_SendEventAction::CTSM_LF_SendEventAction(const std::string& eventSender, const std::string& eventReceiver, const std::string& eventMessage, bool isPlantEvent, long delay)
