...
public:
  ...
  bool deassignScrapBasket(const std::string& Plant, const std::string& OrderId, long ContainerInSeq, long ContainerNo, bool commit);
	...
	bool LastTapEndToPowerOnDelays(CEventMessage &Event,bool pCommit,bool &isDelay); //SARS
	bool LastPowerOffToTapStartDelays(CEventMessage &Event,bool pCommit,bool &isDelay); //SARS
	bool TapStartToTapEndDelays(CEventMessage &Event,bool pCommit,bool &isDelay); //SARS
	bool PowerOffToPowerOnDelays(CEventMessage &Event,bool pCommit,bool &isDelay); //SARS
	bool ExtraPowerOnDelays(CEventMessage &Event,bool pCommit,bool &isDelay); //SARS
...
protected:
  ...
  bool handlePDLiqAdditionOnHeatAnnouncement(CEventMessage& Event, bool commit);//SRKO
